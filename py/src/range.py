...
class Range:
    ...
    def generate_proof(self):
        ...
        beta = fiat_shamir_heuristic(Commitment(0, 1).c.value, alpha_upper_commitment.c.value, r_upper_commitment.c.value)
        ...
        beta = fiat_shamir_heuristic(Commitment(0, 1).c.value, alpha_lower_commitment.c.value, r_lower_commitment.c.value)
    ...
    def verify_proof(proof, lower_bound, upper_bound):
        ...
        beta = fiat_shamir_heuristic(Commitment(0, 1).c.value, proof['ac'], r_upper_commitment.value)
        ...
        beta = fiat_shamir_heuristic(Commitment(0, 1).c.value, proof['bc'], r_lower_commitment.value)
